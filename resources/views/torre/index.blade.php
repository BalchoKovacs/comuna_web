...
<section class="content-header">
  <div class="container-fluid">
    ...
    <div class="col-sm-6 text-right">
     <a class="btn btn-dark" href="{{ route('torre.create') }}">Agregar Nuevo Torre</a>
 </div>
</div>
</div>
</section>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Tabla de Torre</h3>
                </div>
                        ...
                        <table class="text-center table table-striped table-bordered dt-responsive nowrap" id="example">
                            ...
                            <tbody>
                             ...
                             @foreach($data as $key=>$nombre)
                                    ...
                                    <td>
                                        {!! Form::open(['route' => ['torre.destroy', $nombre->id], 'method' => 'delete']) !!}

                                            <a href="{{ route('torre.edit', [$nombre->id]) }}" class='btn btn-success '><i class="fas fa-edit"></i></a>
